...
export function LandingAnimation({ onComplete }) {
  ...
  return (
    <div ref={scope} className="relative select-none flex items-center justify-center min-h-[300px] w-full mt-10">
      ...
      <div id="text-container" className="flex items-end text-[80px] md:text-[120px] font-black leading-none tracking-tighter text-orange-50 relative">
        ...
        <span ref={gentRef} className="relative z-10 overflow-hidden text-orange-100/90 whitespace-nowrap pl-[0.05em] origin-left pb-2 text-[60px] md:text-[90px]" style={{ fontFamily: "ui-sans-serif, system-ui, sans-serif" }}>
          gent
        </span>
        ...
        {/* P, D, F */}
        <span ref={pRef} className="relative z-10 text-orange-300 flex"><LetterP /></span>
        <span ref={dRef} className="relative z-10 text-orange-200 flex"><LetterD /></span>
        <span ref={fRef} className="relative z-10 text-orange-100 flex"><LetterF /></span>
